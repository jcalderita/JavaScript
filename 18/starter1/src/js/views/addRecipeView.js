...
class AddRecipeView extends View {
  ...
  constructor() {
    super();
    this._addHandlerShowHiddenWindow();
  }
  ...
  _addHandlerShowHiddenWindow() {
    this._btnOpen.addEventListener('click', this.showHiddenWindow.bind(this));
    this._btnClose.addEventListener('click', this.showHiddenWindow.bind(this));
    this._overlay.addEventListener('click', this.showHiddenWindow.bind(this));
  }
